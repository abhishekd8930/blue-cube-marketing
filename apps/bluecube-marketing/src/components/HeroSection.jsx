...
export default function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden bg-white pt-2 pb-12 md:pt-4 md:pb-8 lg:pt-4 lg:pb-12 md:h-[calc(100vh-76px)] md:max-h-[calc(100vh-76px)] flex flex-col justify-start">
